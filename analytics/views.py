...
from .models import ProductVersion, VisitSession, UXIssue, DailyStat, UserCohort, PageMetrics, PageHit
...
def compare_versions(request):
    ...
    if v1_id and v2_id:
        try:
            ...
            # Добавляем device split для UI
            stats_v1 = {
                'visits': comparison['stats_v1']['visits'],
            }
            stats_v2 = {
                'visits': comparison['stats_v2']['visits'],
            }
